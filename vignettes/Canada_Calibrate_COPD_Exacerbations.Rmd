---
title: "Canada_Calibrate COPD Exacerbations"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Canada_Calibrate COPD Exacerbations}
...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  eval = TRUE  # Set to FALSE to prevent long-running simulations during package check
)
```
