...
#  input$smoking$mortality_factor_former<- t(as.matrix(c(age40to49 = 1, age50to59 = 1, age60to69 = 1  , age70to79 = 1, age80p = 1 ))) #DEBUG shutting down background mortality adjustment
  ...
  plot_COPD_inc_by_age_sex  <- ggplot(df, aes(x = Age, y = Incidence)) + theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_COPD_inc_by_agegroup  <- ggplot(df, aes(x = Age_Group, y = Incidence)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_COPD_inc_by_year_sex <- ggplot2::ggplot(dfm, aes(x = Year, y = value)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  dfm <- reshape2::melt(df[,c('Year','Male','Female')],id.vars = 1)
  plot_COPD_prev_by_sex <- ggplot2::ggplot(dfm, aes(x = Year, y = value)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_cumul_COPD_prev_by_sex <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_COPD_prev_by_agegroup  <- ggplot2::ggplot(df, aes(x = Age_Group, y = Prevalence)) +  theme_tufte(base_size=14, ticks=FALSE) +
    geom_bar(stat = "identity", position = "dodge", width = 0.2, fill = "#FF6666") +
...
#
  ...
  plot_fev1_by_sex <- ggplot2::ggplot(dfm, aes(Year_with_COPD, value, colour = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_gold_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_exac_severity_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_exac_GOLD_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_exac_rate_by_GOLD_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_exac_rate_by_sex_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_cumul_exac_rate_by_sex_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_sev_exac_by_sex_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_exac_by_age_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  #
  # plot_cost_by_GOLD <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  #
  # plot_Cumul_cost_by_GOLD <- ggplot2::ggplot(Cumul_dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  #   geom_point () + geom_line() + labs(title = "Cost per GOLD stage") + ylab ("Canadian dollars")  +
  #   scale_colour_manual(values = c("#56B4E9", "#66CC99", "gold2" , "#CC6666")) +
...
#
#   plot_QALY_by_GOLD <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
...
#
#   plot_Cumul_QALY_by_GOLD <- ggplot2::ggplot(Cumul_dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
#     geom_point () + geom_line() + labs(title = "QALY per GOLD stage") + ylab ("QALYs")  +
#     scale_colour_manual(values = c("#56B4E9", "#66CC99", "gold2" , "#CC6666")) +
...
#
  ...
  plot_COPD_related_mortality_by_age <- ggplot2::ggplot(dfm, aes(x = Age, y = value)) +  theme_tufte(base_size=14, ticks=FALSE) +
    geom_bar(aes(fill = variable), stat = "identity", position = "dodge") +
    ylim (low=0, high = 20) +
  ...
  plot_COPD_death_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value)) +  theme_tufte(base_size=14, ticks=FALSE) +
    geom_bar(aes(fill = variable), stat = "identity", position = "dodge") +
  ...
  plot_mortality_by_age <- ggplot2::ggplot(dfm, aes(x = Age, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_population_by_sex_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
  ...
  plot_smokers_by_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
...
#  plot_smokers_by_year <- qplot(Year, Smoker, data = smokers_by_year)
  ...
  plot_mortality_by_smoking_per_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value)) +  theme_tufte(base_size=14, ticks=FALSE) +
    geom_bar(aes(fill = variable), stat = "identity", position = "dodge") +
  ...
  plot_all_cause_mortality_COPD  <- ggplot2::ggplot(dfm, aes(x = Year, y = value)) +  theme_tufte(base_size=14, ticks=FALSE) +
    geom_bar(aes(fill = variable), stat = "identity", position = "dodge") +
  ...
  plot_exac_mortality_by_sev_year <- ggplot2::ggplot(dfm, aes(x = Year, y = value)) +  theme_tufte(base_size=14, ticks=FALSE) +
    geom_bar(aes(fill = variable), stat = "identity", position = "dodge") +
  ...
  plot_avg_pack_years_ctime <- ggplot2::ggplot(dfm, aes(x = Year, y = value, color = variable)) +  theme_tufte(base_size=14, ticks=FALSE) +
