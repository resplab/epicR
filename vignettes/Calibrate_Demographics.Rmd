...
lower_bounds <- c(-3.65, 0.0001, -0.00001, -0.005, -0.0001, -0.0005, -0.0005)
...
params <- c(-3.62672063032448, 0.0040274171887977, -4.37035899506131e-05, 0, -1e-02, 0, -0.00532065698144107)
```
...
params <- params <- c(-3.62672063032448, 0.0040274171887977, -4.37035899506131e-05, 0, -1e-02, 0, -0.00532065698144107)
input$values$agent$l_inc_betas <- c(params[1], params[2], params[3])


# intercept, y, y2, age
input$values$agent$ln_h_bgd_betas <- c(params[4], params[5], params[6], params[7], b_mi = 0, n_mi = 0, b_stroke = 0,n_stroke = 0, hf = 0)
