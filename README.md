...
4. **Install gfortran**
   - Download the appropriate gfortran installer from [https://cran.r-project.org/bin/macosx/tools/](https://cran.r-project.org/bin/macosx/tools/)
   - Choose the version that matches your macOS and architecture (Apple Silicon or Intel)
...
- **Solution: Install gfortran** from [https://cran.r-project.org/bin/macosx/tools/](https://cran.r-project.org/bin/macosx/tools/)
