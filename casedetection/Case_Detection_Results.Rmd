...
settings$n_base_agents <- 1e+4 # change number of agents here: 100e+6 is used in the analysis
lambda=50000 # change WTP threshold here
  
init_session(settings = settings)
input <- init_input()

years_btw_case_detection=3 # this script must be run again with 'years_btw_case_detection=5' for a complete analysis set 
