...
#'
#' See the README on
#' \href{https://github.com/resplab/epicR#readme}{GitHub}
#'
#' @name epicR-package
#' @aliases epicR
...
if(getRversion() >= "2.15.1")  utils::globalVariables(c(".",
  "Age", "Age_Group", "CD", "COPD", "Diagnosed", "Diagnosis", "Exacerbation", "Exacerbations", "Female", "GOLD", "id",
  ...
  "diagnosis", "event", "exac_status", "female", "followup_after_COPD",
  ...
  "smoking_status", "time_at_creation", "value", "variable"
))
