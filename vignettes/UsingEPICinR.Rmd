...
**Extended Output from `Cget_output_ex()`:**
...
As shown in the code snippet above, you can inspect the event matrix `Cget_all_events_matrix()` by converting it into a data frame using `as.data.frame(Cget_all_events_matrix())`. This data frame consists of 33 columns, including:
