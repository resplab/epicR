...
#DEBUG all covariates zero - except for intercept
    ...
    fev1_betas_by_sex <- cbind(male = c(intercept = -0.1543 - 0.00762, baseline_age = 0*0.002344, baseline_weight_kg = 0, height =0, height_sq = 0, current_smoker =  0*-0.03074, age_height_sq = 0, followup_time = 0),
                            female = c(intercept = -0.1543 , baseline_age = 0*0.002344, baseline_weight_kg =0, height =0, height_sq =0, current_smoker =  0*-0.03074, age_height_sq = 0, followup_time = 0))
   ...
   fev1_0_inc_sd_by_sex <- c(male = 0*0.54, female = 0*0.36) #debug
