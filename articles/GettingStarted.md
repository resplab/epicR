...
Let’s run a basic simulation with default parameters:
...
EPIC is session-based, meaning you must initialize a session before
running simulations. This allocates the required memory:
