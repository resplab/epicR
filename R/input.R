...
init_input<-function()
{
  ...
  input_help$lung_function$dfev1_betas<-"Regression coefficients for mean of FEV1 at time of creation with COPD or cevelopment of COPD based on Zafar's CMAJ. Used for conditional normal distribution in FEV1 decline equations.  (separately by sex)"
