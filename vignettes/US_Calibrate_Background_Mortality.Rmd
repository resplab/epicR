---
title: "US_Calibrate Background Mortality"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{US_Calibrate Background Mortality}
...
results_smoking <- simulate(settings = settings, input = input$values, return_events = TRUE)
events_smoking <- results_smoking$events
